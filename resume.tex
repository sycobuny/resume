\begin{details}
    ...
    \immediate\write18{test -x output-details.bash && ./output-details.bash}
    \input{outputs/details.tex}
    \email{sbelcher+jobs}{gmail}
    \repo {https://github.com/sycobuny/resume}
\end{details}

\begin{objective}
    % mention design and develop before learning
    % don't say "facilitate" cause I actually do stuff not make it easier
    % hit on "three d"s: design, develop, document
    % enterprise?
...
\begin{skills}
    \begin{category}{Computer Languages}
        % mention cloud software like Heroku's development platform
        % mention "Object-Oriented Design and Programming"
        \skill{
        ...
        \skill{
            Various reporting languages and technologies, such as \LaTeX and
            the XML-based XLST/XSL-FO dialects.
        }
        \skill{
    ...
    \begin{category}{Other}
        \skill{
            ...
            speaking at the DC/Baltimore Perl Workshop, covering the Sass
            language and the PL/Perl PostgreSQL procedural language.
        }
        \skill{
...
\begin{jobs}
    \begin{job}{Programmer}{Kelly Services, Inc.}
        ...
        \accomplishments{
            % re-order so "new features" is first thing mentioned
            % possible "three d" reference point?
            % research scientists for the National Institute on Aging
