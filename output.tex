...
\newenvironment{details}{%
    ...
    \begin{center}%
        % set the footers - this requires a big of \expandafter magic because
        % normally you can't access macros inside of \fancyfoot elements, so
        % we've got to pre-expand them.
...
\newenvironment{jobs}{%
    \newenvironment{job}{%
        % just store these values as someone fills them out
        \newcommand{\position}[1]{\renewcommand{\CJT}{####1}}%
        \newcommand{\duration}[2]{\renewcommand{\CJD}{####1 -- ####2}}%
        \newcommand{\company }[1]{\renewcommand{\CJC}{####1}}%
        \newcommand{\feats   }[1]{\renewcommand{\CJF}{####1}}%
        % initialize variables
        \newcommand{\CJT}{}% Current Job Title
        \newcommand{\CJD}{}% Current Job Duration
        \newcommand{\CJC}{}% Current Job Company
        \newcommand{\CJF}{}% Current Job Feats (syn. accomplishments)
    }{%
...
\newenvironment{education}{%
    \newenvironment{degree}{%
        \newcommand{\qualification}[1]{\renewcommand{\CDQ}{####1}}%
        \newcommand{\received     }[1]{\renewcommand{\CDR}{####1}}%
        \newcommand{\school       }[1]{\renewcommand{\CDS}{####1}}%
        ...
        \newcommand{\CDQ}{}% Current Degree Qualification
        \newcommand{\CDR}{}% Current Degree Received
        \newcommand{\CDS}{}% Current Degree School
        \newcommand{\CDA}{}% Current Degree Achievements
    }{%
        \subHeadline{\CDQ}{\CDR}{\CDS}%
