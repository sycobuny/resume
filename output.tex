...
\newenvironment{details}{%
    ...
    % special command to set header elements only if they're present
    \newcommand{\onlyifline}[1]{\@ifmtarg{##1}{blah}{hi}}%
    ...
    \begin{center}%
        ...
        \onlyifline{\ADDRESS} \onlyifline{\PHONE} \onlyifline{\EMAIL}%
    \end{center}%
}
